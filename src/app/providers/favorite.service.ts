...
export class FavoriteService {
  ...
  prepareMapFromFavourite(favouriteInformationObject: any) {
    const newFavorite = _.clone(this._prepareMapFavouriteViewModel(favouriteInformationObject));
    // console.log(favouriteInformationObject.mapViews);
    favouriteInformationObject.mapViews.map((layer) => {
      // console.log(layer);
    })
  ...
  getVisualizationFiltersFromFavorite(favoriteDetails: any) {
    const favorite: any = _.clone(favoriteDetails);
    const filters: any[] = [];
    if (favorite) {
